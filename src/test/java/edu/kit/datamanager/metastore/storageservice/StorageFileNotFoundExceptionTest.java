...
/**
 * Test StorageFileNotFoundException.
 */
public class StorageFileNotFoundExceptionTest {

  public StorageFileNotFoundExceptionTest() {
  }
  ...
  public void testSomeMethod() {
    ...
    StorageFileNotFoundException sfnfe2 = new StorageFileNotFoundException("another message", sfnfe);
    assertTrue(true);
  }
